...
document.querySelectorAll(".category-btn").forEach(el=>{
    el.addEventListener("click", evt => {
        ...
        document.querySelector('.active-all-categories')?.classList.remove('active-all-categories')
...
document.querySelectorAll(".favorite-categories-btn").forEach(el=>{
    el.addEventListener("click", evt => {
        ...
        document.querySelector('.active-favorite-categories')?.classList.remove('active-favorite-categories')
